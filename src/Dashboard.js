...
//       <div>
//         <h2>
//           {userData?.name || (user.isAnonymous ? "Guest" : "User")} 
//         </h2>
//         <p> Points : {points}</p>
//         <p>Badge :{getBadge(points)}</p>
//       </div>
...
//       Awesome! You are getting better at this.
//     </button>
//   </div>
// )}
// {showBadgeUp && (
...
//     <button onClick={() => setShowBadgeUp(false)}>
//       Nice!!KEEP GOING.
//     </button>
//   </div>
// )}
...
//     <div className="activityList">
//       {activities.map((act) => (
//         <div key={act.id} className="activityCard">
